...
5. Confirm connector availability: `GitHub connector if exposed; otherwise paste CI URLs and log excerpts manually`. If missing, collect evidence manually and mark MISSING_CONNECTOR.
