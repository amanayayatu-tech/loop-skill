...
- Required startup order:
  ...
  9. Dispatch First Goal to triage after heartbeat and state init are confirmed.
...
| State initialized, First Goal not dispatched | Send First Goal to triage | notify-only |
